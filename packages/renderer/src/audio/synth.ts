...
export function playSever(
  ...
  crackGain.gain.setValueAtTime(0.3 * volume, t)
  ...
  shatterGain.gain.setValueAtTime(0.2 * volume, t)
  ...
  ringGain.gain.linearRampToValueAtTime(0.1 * volume, t + 0.12)
...
export function playParadox(
  ...
  subGain.gain.linearRampToValueAtTime(0.15 * volume, t + 0.25)
...
export function playLaunch(ctx: AudioContext, dest: AudioNode, volume: number): void {
  ...
  gain.gain.linearRampToValueAtTime(0.25 * volume, t + 0.2)
  gain.gain.exponentialRampToValueAtTime(0.001, t + 0.35)
  osc.connect(gain).connect(dest)
  osc.start(t)
  osc.stop(t + 0.35)
