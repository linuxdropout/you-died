...
export function GameHud({
  ...
  return (
    <div className="gameHud">
      <PlayerStatus players={playerStatuses} localPlayerId={localPlayerId} />

      <MatchTimer elapsedSeconds={elapsedSeconds} limitSeconds={matchLimitSeconds} />

      <KillFeed events={killEvents} />

      <TimelineBar players={players} winThreshold={winThreshold} localPlayerId={localPlayerId} />
