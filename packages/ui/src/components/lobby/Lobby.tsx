      ...
      <div className="lobbyPanel">
            ...
            return (
              <div
                ...
                className={[
                  ...
                  .join(' ')}
              >
                <span className="lobbySlotSwatch" style={{ backgroundColor: player.color }} />
        ...
        <div className="lobbyActions">
          ...
          {isHost && counting && onCancel && (
            <button type="button" className="lobbyBtn lobbyBtnCancel" onClick={onCancel}>
          ...
          <button type="button" className="lobbyBtn lobbyBtnLeave" onClick={onLeave}>
            BAIL
          </button>
        </div>

        {counting && <div className="lobbyStarting">STARTING IN {countdownSeconds}...</div>}
      </div>
